...
RSpec.describe User, type: :model do
	...
	it 'accepts properly formatted email' do
		emails = ['dirk@mavs.com', 'dirk.nowitzki@mavs.com']
	...
	it 'requires a unique, case insensitive email address' do
		user1 = User.create(name: 'dirk', email: 'dirk@mavs.com', password: 'password', password_confirmation: 'password')
	...
	it 'automatically encrypts the password into password_digest attribute' do
		user = User.create(name: 'dirk', email: 'dirk@mavs.com', password: 'password', password_confirmation: 'password')
